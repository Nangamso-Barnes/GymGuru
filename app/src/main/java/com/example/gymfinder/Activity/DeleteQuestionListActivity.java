...
public class DeleteQuestionListActivity extends AppCompatActivity {
    ListView listView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_delete_question_list); // Use your new layout
        ...
        {startActivity(new Intent(DeleteQuestionListActivity.this, QuestionaireActivity.class));
    ...
    private void loadQuestions() {
        AppDatabase.databaseWriteExecutor.execute(() -> {
            ...
            runOnUiThread(() -> {
                ...
                // Use the adapter in DELETE mode
                adapter = new QuestionAdapter(this, questionList, questionDao, QuestionAdapter.Mode.DELETE);
